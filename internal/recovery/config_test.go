...
func TestLoadConfigAcceptsClosedExplicitConfiguration(t *testing.T) {
	...
	if cfg.Fleet.ProjectID != "project-a" || cfg.History.RecentLimit != 20 || cfg.Fleet.TaskPromptLimit != 250 {
...
func validConfigJSON() string {
  ...
  "fleet":{"mode":"mcp_http","endpoint":"http://127.0.0.1:8790/","project_id":"project-a","snapshot_tool":"snapshot","tasks_tool":"tasks","worklinks_tool":"worklinks","scope":"project","root_task_id":"","limit":500,"active_limit":100,"task_prompt_limit":250,"max_response_bytes":8388608},
